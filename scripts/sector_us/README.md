...
- [x] `월간판정/입력/README.md`에 섹터 입력 설명 추가 (2026-09-12)
- [x] 주간 루틴(`trig_01SSz2iFHLwDLvhmikpfiiXH`) 프롬프트에 4번 「미국 섹터 관측」 단계 신설 (2026-09-12).
      `as_of`·`events`·`missing`만 읽고 판정하지 않는다. 위성 보유 시 T4 행 옆에 병기
- [x] `advisor-global` 스킬 P1 입력표에 「후보 섹터 상태(참고)」 행 추가 (2026-09-12).
      확신도 계산에는 넣지 않는다 — 필수 입력 8개 기준을 바꾸지 않기 위해서다
- [ ] `holdings.json` 생성 (위성 첫 편입 시 · 2027-02~03)
- [ ] 월간 판정 루틴은 **의도적으로 건드리지 않았다** — 섹터는 월간 10지표가 아니다(제안서 §3)
